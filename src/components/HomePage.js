...
const HomePage = ({setNetwork}) => {
    ...
    return(
        ...
        <div>
            ...
            <NavLink to='/nickelodeon' exact className='nick'><img src='https://assets.turbologo.com/blog/en/2021/11/15080205/Nickelodeon-1.png' onClick={()=>{setNetwork(1)}}/></NavLink>
