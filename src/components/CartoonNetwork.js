...
const CartoonNetwork = ({networkArr, selectedShow, setSelectedShow, network, setShows, setNetworkArr}) => {
    console.log('CN', networkArr)
    ...
    return(
        <div className='show-grid'>
            {networkArr.map((element)=>{
                return ( <NetworkShows key={element.id} element={element} selectedShow={selectedShow} setSelectedShow={setSelectedShow} setNetworkArr={setNetworkArr}/>)
            })}
            <div>
